 ...
 * @author rodrigo
 */
public class FrmPesquisarPropriedadeRural extends javax.swing.JDialog
{
...
//        super();
    ...
    private void initComponents()
    {
        ...
        jScrollPane1.setViewportView(jTablePropriedadeRural);
    ...
    {//GEN-HEADEREND:event_btnSelecionarActionPerformed
        if (jTablePropriedadeRural.getSelectedRow() >= 0) {
            this.id = String.valueOf(jTablePropriedadeRural.getValueAt(jTablePropriedadeRural.getSelectedRow(), 0));
            this.nome = String.valueOf(jTablePropriedadeRural.getValueAt(jTablePropriedadeRural.getSelectedRow(), 1));
