 ...
 * @author rodrigo
 */
public class FrmPesquisarGrauSangue extends javax.swing.JDialog
{
...
//        super();
    ...
    private void initComponents()
    {
        ...
        jScrollPane1.setViewportView(jTableGrauSangue);
    ...
    {//GEN-HEADEREND:event_btnSelecionarActionPerformed
        if (jTableGrauSangue.getSelectedRow() >= 0) {
            this.id = String.valueOf(jTableGrauSangue.getValueAt(jTableGrauSangue.getSelectedRow(), 0));
            this.nome = String.valueOf(jTableGrauSangue.getValueAt(jTableGrauSangue.getSelectedRow(), 1));
