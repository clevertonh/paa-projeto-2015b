 ...
 * @author rodrigo
 */
public class FrmPesquisarCategoria extends javax.swing.JDialog
{
...
//        super();
    ...
    {//GEN-HEADEREND:event_btnSelecionarActionPerformed
        if (jTableCategoria.getSelectedRow() >= 0) {
            this.id = String.valueOf(jTableCategoria.getValueAt(jTableCategoria.getSelectedRow(), 0));
            this.nome = String.valueOf(jTableCategoria.getValueAt(jTableCategoria.getSelectedRow(), 1));
