 ...
 * @author cleverton
 */
public class FrmAnimalListagem extends javax.swing.JInternalFrame {

    private FrmAnimalCadastro frm;
    private final AnimalController objController;

    /**
     * Creates new form FrmCategoriaListagem
     */
    public FrmAnimalListagem() {
        //
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableAnimal.setRowSelectionAllowed(false);
    ...
    private void jTableAnimalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAnimalMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            fAbreCadastro((int) jTableAnimal.getValueAt(jTableAnimal.getSelectedRow(), 0));
        }
